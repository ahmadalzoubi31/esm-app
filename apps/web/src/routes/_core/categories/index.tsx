...
import columns from '@/components/web/categories/columns'
import { useCategoriesQuery } from '@/lib/queries'
import { tableConfig } from '@/components/web/categories/table-config'

import { Button } from '@/components/ui/button'
import { PlusIcon } from 'lucide-react'

import { CategoriesStats } from '@/components/web/categories/categories-stats'
import { CategoriesTableSelectionActions } from '@/components/web/categories/table-selection-actions'
...
function RouteComponent() {
  ...
  return (
    <div className="space-y-4">
      <CategoriesStats categories={categoriesData} />
      ...
      <AppDataTable
        ...
        renderSelectionActions={(table) => (
          <CategoriesTableSelectionActions table={table} />
        )}
        renderLeftActions={() => (
