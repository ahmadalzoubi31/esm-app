...
export class Migration20260331105613 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "sla_targets" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "type" varchar(255) not null, "name" varchar(255) not null, "description" text null, "goalMs" int not null, "rules" jsonb not null, "isActive" boolean not null default true, constraint "sla_targets_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "roles" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "name" varchar(255) not null, "description" varchar(255) null, "permissionCount" int null default 0, "userCount" int null default 0, constraint "roles_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "departments" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "name" varchar(255) not null, "description" varchar(255) null, constraint "departments_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "audit_logs" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "entityType" varchar(255) not null, "entityId" varchar(255) not null, "event" varchar(255) not null, "payload" jsonb null, constraint "audit_logs_pkey" primary key ("id"));`);
    this.addSql(`create index "audit_logs_tenantId_index" on "audit_logs" ("tenantId");`);

    this.addSql(`create table "users" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "firstName" varchar(255) not null, "lastName" varchar(255) not null, "username" varchar(80) not null, "email" varchar(255) null, "displayName" varchar(150) null, "avatar" varchar(255) null, "department" varchar(255) null, "phone" varchar(255) null, "manager" varchar(255) null, "authSource" text check ("authSource" in ('local', 'ldap')) not null, "externalId" varchar(255) null, "password" varchar(255) null, "isActive" boolean not null default false, "lastLoginAt" timestamptz null, "isLicensed" boolean not null default false, "metadata" jsonb null, constraint "users_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "groups" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "name" varchar(120) not null, "type" varchar(255) not null, "description" varchar(255) null, "teamLeaderId" varchar(255) null, "businessLineId" varchar(255) not null, constraint "groups_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "cases" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "number" varchar(30) not null, "title" varchar(50) not null, "description" text null, "status" text check ("status" in ('NEW', 'WAITING_FOR_APPROVAL', 'PENDING', 'IN_PROGRESS', 'RESOLVED', 'CLOSED', 'CANCELED')) not null default 'NEW', "priority" text check ("priority" in ('LOW', 'MEDIUM', 'HIGH', 'CRITICAL')) not null default 'MEDIUM', "category" varchar(255) not null, "subcategory" varchar(255) null, "requesterId" varchar(255) not null, "assigneeId" varchar(255) null, "assignmentGroupId" varchar(255) not null, "businessLineId" varchar(255) not null, "affectedServiceId" uuid not null, "requestCardId" uuid null, constraint "cases_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "case_comments" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "caseId" varchar(255) not null, "body" text not null, "isPrivate" boolean not null default true, constraint "case_comments_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "case_attachments" ("id" varchar(255) not null, "tenantId" varchar(255) not null, "createdAt" timestamptz null default CURRENT_TIMESTAMP, "updatedAt" timestamptz null default CURRENT_TIMESTAMP, "isActive" boolean not null default true, "caseId" varchar(255) not null, "filename" varchar(255) not null, "originalName" varchar(255) not null, "mimeType" varchar(255) not null, "size" int not null, "storagePath" varchar(255) not null, constraint "case_attachments_pkey" primary key ("id"));`);
