...
export class Migration20260209115541 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "roles" ("id" uuid not null, "key" varchar(255) not null, "name" varchar(255) not null, "description" varchar(255) null, "permission_count" int not null default 0, "user_count" int not null default 0, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "roles_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "groups" ("id" uuid not null, "name" varchar(120) not null, "type" varchar(255) not null, "description" varchar(255) null, "teamLeaderId" varchar(255) null, "business_line_key" varchar(255) not null, "businessLineId" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "groups_pkey" primary key ("id"));`);

    this.addSql(`create table "group_users" ("groupId" uuid not null, "userId" varchar(255) not null, constraint "group_users_pkey" primary key ("groupId", "userId"));`);

    this.addSql(`create table "group_roles" ("role_id" uuid not null, "group_id" uuid not null, constraint "group_roles_pkey" primary key ("role_id", "group_id"));`);

    this.addSql(`create table "group_permissions" ("permission_id" uuid not null, "group_id" uuid not null, constraint "group_permissions_pkey" primary key ("permission_id", "group_id"));`);
    ...
    this.addSql(`create table "user_roles" ("role_id" uuid not null, "user_id" varchar(255) not null, constraint "user_roles_pkey" primary key ("role_id", "user_id"));`);
