...
export class PermissionSeeder extends Seeder {
  data = [
    ...
    // HR Business Line Permissions
    {
      key: 'case:read:hr',
      subject: 'Case',
      action: 'read',
      category: 'HR Business Line',
      conditions: {
        field: 'businessLineKey',
        op: 'eq',
        value: 'hr',
      },
      description:
        'Allows viewing HR-specific cases. Use this for HR Staff needing access to HR tickets but not IT or Finance.',
    },
    {
      key: 'case:manage:hr',
      subject: 'Case',
      ...
      description:
        'Allows full management of HR cases. Use this for HR Managers.',
    },
    {
      key: 'group:manage:hr',
      subject: 'Group',
      ...
      description:
        'Allows managing HR support groups. Use this for HR Operations Leads.',
    },

    // IT Business Line Permissions
    {
      key: 'case:read:it',
      subject: 'Case',
      action: 'read',
      category: 'IT Business Line',
      conditions: {
        field: 'businessLineKey',
        op: 'eq',
        value: 'it',
      },
      description: 'Allows viewing IT-specific cases. Use this for IT Staff.',
    },
    {
      key: 'case:manage:it',
      subject: 'Case',
      ...
      description:
        'Allows full management of IT cases. Use this for IT Managers.',
    },
    {
      key: 'group:manage:it',
      subject: 'Group',
      ...
      description:
        'Allows managing IT support groups. Use this for IT Operations Leads.',
    },

    // Finance Business Line Permissions
    {
      key: 'case:read:finance',
      subject: 'Case',
      action: 'read',
      category: 'Finance Business Line',
      conditions: {
        field: 'businessLineKey',
        op: 'eq',
        value: 'finance',
      ...
      description:
        'Allows viewing Finance-specific cases. Use this for Finance Staff.',
    },
    {
      key: 'case:manage:finance',
      subject: 'Case',
      action: 'manage',
      category: 'Finance Business Line',
      conditions: {
      ...
      description:
        'Allows full management of Finance cases. Use this for Finance Managers.',
    },
    {
      key: 'group:manage:finance',
      subject: 'Group',
      action: 'manage',
      category: 'Finance Business Line',
      conditions: {
      ...
      description:
        'Allows managing Finance support groups. Use this for Finance Operations Leads.',
    },
